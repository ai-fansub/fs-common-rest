package com.fs.process.rest.util;
...
public class HttpLogUtils {
    ...
    public static boolean isExcludedRequest(HttpServletRequest request) {
        ...
        return "GET".equals(method) && startsWithAny(uri, "/webjars", "/swagger-resources", "/v2/api-docs", "/csrf");
    }
    ...
    public static boolean isCriticalException(Object responseObject) {
        if (responseObject instanceof FsCommonException) {
            FsCommonException hce = (FsCommonException) responseObject;
